# ESERCIZIO 26-11-24: Ciclo while e condizioni if per richiedere all’utente di inserire tre numeri pari negativi. Il programma continua fino a quando l’utente non inserisce correttamente tre numeri che soddisfano il criterio.
